...
namespace AgroBridge
{
	public partial class ProfileInfoClass : Form
	{
		...
		private String ID;
        string connectionString = "data source=X1-YOGA\\SQLEXPRESS; database=AgroBridge; integrated security=SSPI"; // Set up  connection string
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "data source=X1-YOGA\\SQLEXPRESS; database=AgroBridge; integrated security=SSPI";
